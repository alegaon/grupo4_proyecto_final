...
def update_task(task_id):
    ...
    task.comida = data['comida']
    task.embarcacion = data['embarcacion']
    task.guia = data['guia']
    task.equipos = data['equipos']
    task.carnada = data['carnada']
    task.wifi = data['wifi']
    task.hospedaje = data['hospedaje']
    task.atencion = data['atencion']
    task.salvavidas = data['salvavidas']
    task.save()
